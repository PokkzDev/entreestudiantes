...
- **Contacto directo**: Comunícate con otros estudiantes por WhatsApp, email o teléfono, según la preferencia del anunciante, sin intermediarios.
- **Eliminación de cuenta**: Elimina tu cuenta de forma permanente, con registro de motivo opcional y borrado seguro de tus datos y publicaciones.

## Flujos principales de la app

1. **Registro y verificación**: El usuario se registra con su correo, recibe un email de verificación y completa su perfil.
2. **Inicio de sesión**: Acceso mediante correo o usuario y contraseña. Opción de mantener la sesión iniciada.
3. **Publicar**: Elige tipo (producto/servicio), categoría, añade detalles, imágenes y contacto. Confirma y publica.
4. **Gestión de publicaciones**: Desde "Mis Publicaciones" puedes editar, pausar/reactivar, eliminar o ver tus anuncios.
5. **Búsqueda y exploración**: Usa filtros para encontrar productos o servicios. Accede a la ficha de cada publicación y contacta directamente al anunciante.
6. **Configuración de cuenta**: Cambia tu contraseña, revisa tus datos, elimina tu cuenta si lo deseas.

## Intención y valores

- **Comunidad universitaria**: Solo estudiantes, para fomentar confianza y apoyo mutuo.
- **Sin intermediarios**: El contacto es directo entre usuarios, sin comisiones ni terceros.
- **Privacidad y seguridad**: Datos protegidos, verificación de email y control total sobre tu cuenta.
- **Facilidad de uso**: Interfaz intuitiva, rápida y adaptada a dispositivos móviles.

# Obtener Estado de Pago por ID de Comercio

Este método permite obtener el estado de un pago en base al `commerceId` (identificador de la orden del comercio).
...
*   **Production server (uses live data):** `https://www.flow.cl/api/payment/getStatusByCommerceId`
*   **Sandbox server (uses test data):** `https://sandbox.flow.cl/api/payment/getStatusByCommerceId`
...
| `commerceId`| Sí        | string | Orden del comercio                               |
